// src/components/FileExplorerItem.js
...
// Small orange dot that appears when expandable
function DotIcon() {
  return (
    <Box
      sx={{
...
// Choose the right icon for each file type
...
// The exported CustomTreeItem component
